        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RazaoSocial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModeloProdutos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModeloProdutos_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdutoId = table.Column<int>(type: "int", nullable: false),
                    ModeloProdutoId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModeloProdutos_ProdutoId",
                table: "ModeloProdutos",
                column: "ProdutoId");
